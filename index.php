...
<html>
<head>
<title>Launch Page: Alphonso Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="alphonsoForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Alphonso, Level 1</option>
				<option value="02">Alphonso, Level 2</option>
				<option value="03">Alphonso, Level 3</option>
				<option value="04">Alphonso, Level 4</option>
				<option value="05">Alphonso, Level 5</option>
				<option value="06">Alphonso, Level 6</option>
				<option value="07">Alphonso, Level 7</option>
				<option value="08">Alphonso, Level 8</option>
				<option value="09">Alphonso, Level 9</option>
				<option value="10">Alphonso, Level 10</option>
			  </select>
        ...
        {
            $("#alphonsoForm").attr('action', "alphonso/alphonso"+ $("#level").val() +  ".php");
        });
